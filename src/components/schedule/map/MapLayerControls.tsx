...
export const MapLayerControls: React.FC<MapLayerControlsProps> = ({
  ...
  return (
    <div className="absolute left-4 top-4 z-10">
      <div className="bg-white p-2 rounded-md shadow-md space-y-2 border">
        ...
        <div className="border-t pt-2 mt-2">
          ...
          <div className="flex flex-col space-y-1">
            <Button
              variant="outline"
              size="sm"
              className="text-xs h-7 px-2 flex items-center justify-start"
              onClick={onAddTask}
            >
            ...
            >
              <Edit className="h-3 w-3 mr-1" /> Edit Selected Task
            </Button>
          </div>
        </div>
      </div>
